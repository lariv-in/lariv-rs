//! Axum extractor for `#[html_form]` POST bodies (duplicate field names supported).
...
use super::{FormError, HtmlForm};

/// POST body extractor for types generated by `#[html_form]`.
///
