...
crate::define_plugin_routes! {
    ...
    routes: [
        ...
        get TaskLogsRouteTag, "/tasks/{id}/logs", handlers::logs::list, fragment(TaskLogsKey);
        post TaskLogAddPostRouteTag, "/tasks/{id}/logs", handlers::logs::add_post, fragment(TaskLogsKey);
        ...
        get TaskDetailRouteTag, "/tasks/{id}", handlers::tasks::detail;
